...
from .knobs import initialize_knobs, save_knobs, get_default_knobs, knob2action, get_input_space_adapter, get_original_knob_details
...
class BenchEnv(DBEnv):
    ...
    def step_SMAC(self, knobs, seed):
        ...
        # print(knobs_display)
        original_knob_details = get_original_knob_details()
        for k in knobs_display.keys():
            if original_knob_details[k]['type'] == 'integer' and original_knob_details[k]['max'] > sys.maxsize:
